...
namespace PredictTaxiFareML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\My Stuff\Practise Projects\Machine Learning for dot net developers\C# Machine Learning Projects\PredictTaxiFare\Consolidated.csv";
        private static string MODEL_FILEPATH = @"../../../../PredictTaxiFareML.Model/MLModel.zip";
