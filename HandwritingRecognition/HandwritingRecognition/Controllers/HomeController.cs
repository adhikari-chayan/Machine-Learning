...
namespace HandwritingRecognition.Controllers
{
    public class HomeController : Controller
    {
        ...
        /*
         The input image is 256 x 256 pixels in size with a white background. The following method shrinks the original image to 32 x 32 pixels and then aggregates by 4 x 4 pixel areas as the final pixel values. The aggregation counts non-white pixels as a 1 and pure white pixels as 0, which makes a 4 x 4 area with a value in the range of 0 to 16. The aggregated values are then fed into the prediction engine.
       */
